...
const firebaseConfig = {
  apiKey: "AIzaSyDN6M1tcKPq_jxAfRUZyb3Nxq4ZvZNe4A0",
  authDomain: "quiniela-comando.firebaseapp.com",
  projectId: "quiniela-comando",
  storageBucket: "quiniela-comando.firebasestorage.app",
  messagingSenderId: "165787924829",
  appId: "1:165787924829:web:168bb3aea60ca6fef350b4"
};
    ...
    <div class="dashboard-grid">
      <div class="panel-card">
        ...
        <div style="text-align: right; margin-top: 1rem;">
          <button class="btn btn-secondary btn-sm" onclick="setRankingPhase(null); switchTab('ranking')">Ver tabla completa →</button>
        </div>
      </div>
...
function calculateScores(phaseFilter) {
  ...
  state.participants.forEach(p => {
    ...
    // 1. Matches scoring
    state.matches.forEach(m => {
      if (phaseFilter && (Array.isArray(phaseFilter) ? !phaseFilter.includes(m.phase) : m.phase !== phaseFilter)) return;
      const pred = pPreds[m.id];
      const hasOfficial = m.scoreA !== null && m.scoreB !== null;
